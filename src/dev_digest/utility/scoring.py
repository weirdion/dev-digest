...
GOVERNMENT_TERMS = ("education", "schools", "policy", "partnership")
NEG_WEBINAR_TERMS = ("webinar", "podcast", "training", "certification", "partner", "regional", "kubecon", "co-located event", "community days", "summer of code")
